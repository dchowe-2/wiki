...
CS225 has 6 smaller exams and a final, with the smaller exams being 50 minutes long and the final being 110 minutes long. The first exam is an "Exam 0", covering knowledge from CS 225's prereqs, including coding, Big-O Runtime, graphs, and trees. They typically consist of a few multiple choice and short answer questions, and one programming question. The short answer question will ask you to pick the most efficient data structure as well as explain its Big-O runtime. The professors provide practice exams on PrarieLearn and a video walkthrough on MediaSpace. All of the exams are taken through the CBTF, and so are scheduled through their website.
...
|Extra Credit (capped at 70 points, Fall 2025) | |
|--- | --- | 
Early MP submission (Except first MP) | 20 points 
Problem of the Day | 30 points
Course Feedback Surverys | 16 points 
Additiional Points Announced by Professor (Example: lab_dict was 4 EC points, Fall 2025) 

## Instructors

Currently, Carl Evans and Brad Solomon are the primary instructors for CS 225. In Fall 2025, professors were rotated between Brad, Harsha Tirumala, and Mattox Beckman.  
