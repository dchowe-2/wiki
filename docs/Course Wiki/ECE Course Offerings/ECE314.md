...
Taking [ECE314](ECE314.md) is an excellent way to get 1 of the 3 labs required for EE majors. Taking it concurrently with [ECE313](ECE313.md) should be no problem as the lectures line up well with the labs. [ECE314](ECE314.md) and [ECE311](ECE311.md) have very similar structure, with both having Python labs using Jupyter Notebook, so taking one of these classes helps to prepare you for the other.
...
The material in [ECE314](ECE314.md) tends to be ahead of [ECE313](ECE313.md), so you sometimes have to do labs on material before it is covered in [ECE313](ECE313.md) if you are taking these classes concurrently. When this happens, it is important to go to lecture or watch the videos to learn the content needed for the lab.
